  ...
  <div class="panel__body">
    <div class="form-grid">
      ...
      <div class="field col-span-2" data-when-cust="business"><label class="req">Company (the customer of record)</label>
        <input class="input" name="company" data-cust-req="business" value="<?= e(old('company')) ?>">
      ...
      <div class="field"><label class="req">First name</label><input class="input" name="first_name" data-cust-req="person" required value="<?= e(old('first_name')) ?>"></div>
      <div class="field"><label class="req">Last name</label><input class="input" name="last_name" data-cust-req="person" required value="<?= e(old('last_name')) ?>"></div>
      <div class="field"><label class="req">Phone</label><input class="input" name="phone" data-mask="phone" required placeholder="(503) 555-0123" value="<?= e(old('phone')) ?>"></div>
      <div class="field"><label>Second phone</label><input class="input" name="phone2" data-mask="phone" value="<?= e(old('phone2')) ?>"></div>
      <div class="field col-span-2"><label>Email</label><input class="input" name="email" type="email" value="<?= e(old('email')) ?>"></div>
      <div class="field col-span-2"><label>Address</label><input class="input" name="address_line1" value="<?= e(old('address_line1')) ?>"></div>
      <div class="field"><label>City</label><input class="input" name="city" value="<?= e(old('city')) ?>"></div>
      <div class="field"><label>State</label>
        <select class="select" name="state"><?php foreach (us_states() as $s): ?><option <?= $s === old('state', 'OR') ? 'selected' : '' ?>><?= e($s) ?></option><?php endforeach; ?></select></div>
      <div class="field"><label>ZIP</label><input class="input" name="postal_code" value="<?= e(old('postal_code')) ?>"></div>
    </div>
    ...
    <div class="field mt4"><label>Provider code</label><input class="input" name="provider_code" placeholder="CMC-2026" value="<?= e(old('provider_code')) ?>"></div>
    <div class="field"><label>Notes</label><textarea class="textarea" name="notes"><?= e(old('notes')) ?></textarea></div>
  </div>
