...
<div class="panel mb4"><div class="panel__body">
  <form method="get" class="row wrap">
    ...
    <input class="input" name="q" value="<?= e($q) ?>" placeholder="Name, company, phone or email…" style="max-width:340px">
...
<?php if (!$rows): ?>
  <div class="empty"><div class="empty__icon">☺</div><div class="empty__title">No customers match</div>
...
<?php else: ?>
  <div class="table-wrap"><table class="tbl">
    <thead><tr><th>Name</th><th>Type</th><th>Phone</th><th>Email</th><th>SMS</th><th>City</th><th class="right">Added</th></tr></thead>
    <tbody>
    <?php foreach ($rows as $r): ?>
      <tr data-href="<?= url('customers/' . $r['id']) ?>">
        <td class="strong"><?= e(customer_name($r, true)) ?>
          <?php if ((int) $r['is_provider'] === 1): ?><span class="badge badge--accent" style="margin-left:6px"><i></i>Provider</span><?php endif; ?>
          <?php if (($d = Rules::termsDays($r['payment_terms'])) !== null): ?><span class="badge badge--info" style="margin-left:6px"><i></i>Net <?= $d ?></span><?php endif; ?></td>
